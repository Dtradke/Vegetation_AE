...
def getModelAndTrain(masterDataSet, mod, test_set, load_datasets=False, save_mod=False):
    if mod is None:
        if SPLIT:
            ...
            X_split_1, X_split_2 = masterDataSet.trainX[:,:,:,:3], masterDataSet.trainX[:,:,:,4:]

            # val_split_1 = np.stack((masterDataSet.valX[:,:,:,0], masterDataSet.valX[:,:,:,2]), axis=3)
            # val_split_2 = masterDataSet.valX[:,:,:,3:]

            val_split_1, val_split_2 = masterDataSet.valX[:,:,:,:3], masterDataSet.valX[:,:,:,4:]
...
def modPredict(mod, masterDataSet):
    print("Predicting...")
    if SPLIT:
        X_split_1, X_split_2 = masterDataSet.testX[:,:,:,:3], masterDataSet.testX[:,:,:,4:]
