...
#                 "rmse": 10.179926}
# metric
ynet_results = {0:{0.6:0.472499},
                0.6:{1.83:1.2256},
                1.83:{6:2.02, 15.25:2.02},
                6:{15.25:2.2259},
                15.25:{24.4:3.22566},
                24.4:{76.5:8.033704},
                "r": 0.830255,
...
def calcError(y_preds, ground, lower=0, upper=2):
    ...
    print("Confidence = mean: ", mean, " ... upper: ", (mean + (1.96*(std / np.sqrt(ground.size)))), " ... lower: ",  (mean - (1.96*(std / np.sqrt(ground.size)))), " ... added: ", (1.96*(std / np.sqrt(ground.size))), " ... 85% within: ", np.sort(diff)[int(diff.size * 0.85)])
